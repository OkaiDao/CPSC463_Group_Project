...
import static cap6.Capability6.currentGuestInfo_reservation;
    ...
    private static void updateReservation(Scanner scanner, Hotel hotel) throws ParseException {
        ...
        if (reservation != null) {
            ...
            while (selectedOption != 0) {
                ...
                System.out.println("Select 4 to update the reservation to checked in");
                ...
                if (selectedOption == 1) {
                    ...
                    currentGuestInfo_reservation(hotel, reservation);
